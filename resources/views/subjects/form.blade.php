<h6 class="heading-small text-muted mb-4">Datos de la Materia</h6>
<div class="pl-lg-4">
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-control form-control-alternative"
                    placeholder="Agregar un Nombre" value="{{ old('name', $subject->name) }}">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input type="text" id="description" name="description" class="form-control form-control-alternative"
                placeholder="Agregar una descripcion" value="{{ old('description', $subject->description) }}">
        </div>
    </div>
</div>
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input type="text" id="duration" name="duration" class="form-control form-control-alternative"
                placeholder="Agregar una Duracion" value="{{ old('duration', $subject->duration) }}">
        </div>
    </div>
</div>
